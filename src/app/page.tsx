...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-brand-dark flex flex-col items-center justify-start pt-[15vh] sm:pt-[18vh] md:justify-center md:pt-0 px-3 py-8 md:p-4">
          ...
          {submitted ? (
            <p className="text-brand-gold text-sm md:text-base">
              {alreadyExists
                ...
                : <>You&apos;ve just joined <span className="font-bold">{waitlistCount + 80}</span> others waiting for a better way to import cars. We&apos;ll notify you when we launch!</>}
            </p>
          ) : (
      ...
      {/* Follow on Instagram */}
      <a
        href="https://instagram.com/autobridge.ng"
        target="_blank"
        rel="noopener noreferrer"
        className="mt-6 inline-flex items-center gap-2 text-white/70 hover:text-brand-gold transition-colors text-sm"
      >
